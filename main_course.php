                        ...
                        <div class="row video-selection-container">
                            ...
                            <div class="col-md-6 col-lg-4 mb-4">
                                <div class="card video-card" data-video-id="30">
                                    <div class="card-body">
                                        <div class="video-container">
                                            <iframe src="https://www.youtube.com/embed/FGoeXukNJHY" title="Important & Sensitive Linux Files" allowfullscreen></iframe>
                                        </div>
                                        <h5 class="card-title">Important & Sensitive Linux Files</h5>
                                        <p class="card-text">Key Linux files for security.</p>
                                        <a href="https://www.youtube.com/watch?v=FGoeXukNJHY" target="_blank" class="card-btn">Watch on YouTube <i class="fas fa-external-link-alt ms-2"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row video-selection-container">
                            <div class="col-md-6 col-lg-4 mb-4">
                                <div class="card video-card" data-video-id="31">
                                    <div class="card-body">
                                        <div class="video-container">
                                            <iframe src="https://www.youtube.com/embed/ryZJn1KoUUo" title="What is Network" allowfullscreen></iframe>
                                        </div>
                                        <h5 class="card-title">What is Network</h5>
                                        <p class="card-text">Basics of networking in cybersecurity.</p>
                                        <a href="https://www.youtube.com/watch?v=ryZJn1KoUUo" target="_blank" class="card-btn">Watch on YouTube <i class="fas fa-external-link-alt ms-2"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4 mb-4">
                                <div class="card video-card" data-video-id="32">
                                    <div class="card-body">
                                        <div class="video-container">
                                            <iframe src="https://www.youtube.com/embed/pZ1Dz4AhzcE" title="IP Addresses" allowfullscreen></iframe>
                                        </div>
                                        <h5 class="card-title">IP Addresses</h5>
                                        <p class="card-text">Understanding IP addresses in networks.</p>
                                        <a href="https://www.youtube.com/watch?v=pZ1Dz4AhzcE" target="_blank" class="card-btn">Watch on YouTube <i class="fas fa-external-link-alt ms-2"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4 mb-4">
                                <div class="card video-card" data-video-id="33">
                                    <div class="card-body">
                                        <div class="video-container">
                                            <iframe src="https://www.youtube.com/embed/FhfjyxGlQ9A" title="Switches & Routers" allowfullscreen></iframe>
                                        </div>
                                        <h5 class="card-title">Switches & Routers</h5>
                                        <p class="card-text">Role of switches and routers in networks.</p>
                                        <a href="https://www.youtube.com/watch?v=FhfjyxGlQ9A" target="_blank" class="card-btn">Watch on YouTube <i class="fas fa-external-link-alt ms-2"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4 mb-4">
                                <div class="card video-card" data-video-id="34">
                                    <div class="card-body">
                                        <div class="video-container">
                                            <iframe src="https://www.youtube.com/embed/q78ydrn4ZnY" title="Ports & Protocols" allowfullscreen></iframe>
                                        </div>
                                        <h5 class="card-title">Ports & Protocols</h5>
                                        <p class="card-text">Key ports and protocols in networking.</p>
                                        <a href="https://www.youtube.com/watch?v=q78ydrn4ZnY" target="_blank" class="card-btn">Watch on YouTube <i class="fas fa-external-link-alt ms-2"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4 mb-4">
                                <div class="card video-card" data-video-id="35">
                                    <div class="card-body">
                                        <div class="video-container">
                                            <iframe src="https://www.youtube.com/embed/3SBGzaHx6No" title="NMAP" allowfullscreen></iframe>
                                        </div>
                                        <h5 class="card-title">NMAP</h5>
                                        <p class="card-text">Using NMAP for network scanning.</p>
                                        <a href="https://www.youtube.com/watch?v=3SBGzaHx6No" target="_blank" class="card-btn">Watch on YouTube <i class="fas fa-external-link-alt ms-2"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4 mb-4">
                                <div class="card video-card" data-video-id="36">
                                    <div class="card-body">
                                        <div class="video-container">
                                            <iframe src="https://www.youtube.com/embed/YxtHcIvpHFE" title="TCP & UDP Protocol" allowfullscreen></iframe>
                                        </div>
                                        <h5 class="card-title">TCP & UDP Protocol</h5>
                                        <p class="card-text">Differences between TCP and UDP.</p>
                                        <a href="https://www.youtube.com/watch?v=YxtHcIvpHFE" target="_blank" class="card-btn">Watch on YouTube <i class="fas fa-external-link-alt ms-2"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row video-selection-container">
                            <div class="col-md-6 col-lg-4 mb-4">
                                <div class="card video-card" data-video-id="37">
                                    <div class="card-body">
                                        <div class="video-container">
                                            <iframe src="https://www.youtube.com/embed/FbEDcqV6q_M" title="What is Website" allowfullscreen></iframe>
                                        </div>
                                        <h5 class="card-title">What is Website</h5>
                                        <p class="card-text">Basics of how websites work.</p>
                                        <a href="https://www.youtube.com/watch?v=FbEDcqV6q_M" target="_blank" class="card-btn">Watch on YouTube <i class="fas fa-external-link-alt ms-2"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4 mb-4">
                                <div class="card video-card" data-video-id="38">
                                    <div class="card-body">
                                        <div class="video-container">
                                            <iframe src="https://www.youtube.com/embed/EEaVo9G9bGU" title="What is Data Base" allowfullscreen></iframe>
                                        </div>
                                        <h5 class="card-title">What is Data Base</h5>
                                        <p class="card-text">Understanding databases in web security.</p>
                                        <a href="https://www.youtube.com/watch?v=EEaVo9G9bGU" target="_blank" class="card-btn">Watch on YouTube <i class="fas fa-external-link-alt ms-2"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4 mb-4">
                                <div class="card video-card" data-video-id="39">
                                    <div class="card-body">
                                        <div class="video-container">
                                            <iframe src="https://www.youtube.com/embed/oz8hro5B6IM" title="Client & Server" allowfullscreen></iframe>
                                        </div>
                                        <h5 class="card-title">Client & Server</h5>
                                        <p class="card-text">Client-server architecture explained.</p>
                                        <a href="https://www.youtube.com/watch?v=oz8hro5B6IM" target="_blank" class="card-btn">Watch on YouTube <i class="fas fa-external-link-alt ms-2"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4 mb-4">
                                <div class="card video-card" data-video-id="40">
                                    <div class="card-body">
                                        <div class="video-container">
                                            <iframe src="https://www.youtube.com/embed/G2C-N-rNL0M" title="Domains & Sub-Domains" allowfullscreen></iframe>
                                        </div>
                                        <h5 class="card-title">Domains & Sub-Domains</h5>
                                        <p class="card-text">Understanding domains and sub-domains.</p>
                                        <a href="https://www.youtube.com/watch?v=G2C-N-rNL0M" target="_blank" class="card-btn">Watch on YouTube <i class="fas fa-external-link-alt ms-2"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4 mb-4">
                                <div class="card video-card" data-video-id="41">
                                    <div class="card-body">
                                        <div class="video-container">
                                            <iframe src="https://www.youtube.com/embed/G12XwBexxnU" title="Request & Responses" allowfullscreen></iframe>
                                        </div>
                                        <h5 class="card-title">Request & Responses</h5>
                                        <p class="card-text">How requests and responses work in web.</p>
                                        <a href="https://www.youtube.com/watch?v=G12XwBexxnU" target="_blank" class="card-btn">Watch on YouTube <i class="fas fa-external-link-alt ms-2"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4 mb-4">
                                <div class="card video-card" data-video-id="42">
                                    <div class="card-body">
                                        <div class="video-container">
                                            <iframe src="https://www.youtube.com/embed/vPeD_q4NHxY" title="Cookies are Tasty" allowfullscreen></iframe>
                                        </div>
                                        <h5 class="card-title">Cookies are Tasty</h5>
                                        <p class="card-text">Role of cookies in web security.</p>
                                        <a href="https://www.youtube.com/watch?v=vPeD_q4NHxY" target="_blank" class="card-btn">Watch on YouTube <i class="fas fa-external-link-alt ms-2"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4 mb-4">
                                <div class="card video-card" data-video-id="43">
                                    <div class="card-body">
                                        <div class="video-container">
                                            <iframe src="https://www.youtube.com/embed/QLOb6OY8wQ8" title="Http & Https" allowfullscreen></iframe>
                                        </div>
                                        <h5 class="card-title">Http & Https</h5>
                                        <p class="card-text">Differences between HTTP and HTTPS.</p>
                                        <a href="https://www.youtube.com/watch?v=QLOb6OY8wQ8" target="_blank" class="card-btn">Watch on YouTube <i class="fas fa-external-link-alt ms-2"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4 mb-4">
                                <div class="card video-card" data-video-id="44">
                                    <div class="card-body">
                                        <div class="video-container">
                                            <iframe src="https://www.youtube.com/embed/gTlfJQcGFf4" title="HTTP Methods" allowfullscreen></iframe>
                                        </div>
                                        <h5 class="card-title">HTTP Methods</h5>
                                        <p class="card-text">Understanding HTTP methods in web security.</p>
                                        <a href="https://www.youtube.com/watch?v=gTlfJQcGFf4" target="_blank" class="card-btn">Watch on YouTube <i class="fas fa-external-link-alt ms-2"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4 mb-4">
                                <div class="card video-card" data-video-id="45">
                                    <div class="card-body">
                                        <div class="video-container">
                                            <iframe src="https://www.youtube.com/embed/4lu-US-sx-Q" title="Burp Suite" allowfullscreen></iframe>
                                        </div>
                                        <h5 class="card-title">Burp Suite</h5>
                                        <p class="card-text">Using Burp Suite for web security testing.</p>
                                        <a href="https://www.youtube.com/watch?v=4lu-US-sx-Q" target="_blank" class="card-btn">Watch on YouTube <i class="fas fa-external-link-alt ms-2"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4 mb-4">
                                <div class="card video-card" data-video-id="46">
                                    <div class="card-body">
                                        <div class="video-container">
                                            <iframe src="https://www.youtube.com/embed/36uhcX1T73g" title="HTTP Status Codes" allowfullscreen></iframe>
                                        </div>
                                        <h5 class="card-title">HTTP Status Codes</h5>
                                        <p class="card-text">Learn about HTTP status codes.</p>
                                        <a href="https://www.youtube.com/watch?v=36uhcX1T73g" target="_blank" class="card-btn">Watch on YouTube <i class="fas fa-external-link-alt ms-2"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row video-selection-container">
                            <div class="col-md-6 col-lg-4 mb-4">
                                <div class="card video-card" data-video-id="47">
                                    <div class="card-body">
                                        <div class="video-container">
                                            <iframe src="https://www.youtube.com/embed/eD3anOShL2s" title="OWASP 1" allowfullscreen></iframe>
                                        </div>
                                        <h5 class="card-title">OWASP 1</h5>
                                        <p class="card-text">Introduction to OWASP top vulnerabilities.</p>
                                        <a href="https://www.youtube.com/watch?v=eD3anOShL2s" target="_blank" class="card-btn">Watch on YouTube <i class="fas fa-external-link-alt ms-2"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4 mb-4">
                                <div class="card video-card" data-video-id="48">
                                    <div class="card-body">
                                        <div class="video-container">
                                            <iframe src="https://www.youtube.com/embed/YyaiDx3GlNg" title="OWASP 2" allowfullscreen></iframe>
                                        </div>
                                        <h5 class="card-title">OWASP 2</h5>
                                        <p class="card-text">Exploring OWASP vulnerabilities part 2.</p>
                                        <a href="https://www.youtube.com/watch?v=YyaiDx3GlNg" target="_blank" class="card-btn">Watch on YouTube <i class="fas fa-external-link-alt ms-2"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4 mb-4">
                                <div class="card video-card" data-video-id="49">
                                    <div class="card-body">
                                        <div class="video-container">
                                            <iframe src="https://www.youtube.com/embed/y2KxnPoas-Y" title="OWASP 3" allowfullscreen></iframe>
                                        </div>
                                        <h5 class="card-title">OWASP 3</h5>
                                        <p class="card-text">Exploring OWASP vulnerabilities part 3.</p>
                                        <a href="https://www.youtube.com/watch?v=y2KxnPoas-Y" target="_blank" class="card-btn">Watch on YouTube <i class="fas fa-external-link-alt ms-2"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4 mb-4">
                                <div class="card video-card" data-video-id="50">
                                    <div class="card-body">
                                        <div class="video-container">
                                            <iframe src="https://www.youtube.com/embed/5fzAi-Cmp_A" title="OWASP 4" allowfullscreen></iframe>
                                        </div>
                                        <h5 class="card-title">OWASP 4</h5>
                                        <p class="card-text">Exploring OWASP vulnerabilities part 4.</p>
                                        <a href="https://www.youtube.com/watch?v=5fzAi-Cmp_A" target="_blank" class="card-btn">Watch on YouTube <i class="fas fa-external-link-alt ms-2"></
</div>
                            <div class="col-md-6 col-lg-4 mb-4">
                                <div class="card video-card" data-video-id="51">
                                    <div class="card-body">
                                        <div class="video-container">
                                            <iframe src="https://www.youtube.com/embed/_6ON9sGZ0kg" title="OWASP 5" allowfullscreen></iframe>
                                        </div>
                                        <h5 class="card-title">OWASP 5</h5>
                                        <p class="card-text">Exploring OWASP vulnerabilities part 5.</p>
                                        <a href="https://www.youtube.com/watch?v=_6ON9sGZ0kg" target="_blank" class="card-btn">Watch on YouTube <i class="fas fa-external-link-alt ms-2"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row video-selection-container">
                            <div class="col-md-6 col-lg-4 mb-4">
                                <div class="card video-card" data-video-id="52">
                                    <div class="card-body">
                                        <div class="video-container">
                                            <iframe src="https://www.youtube.com/embed/WS2TB8_RiJk" title="Weaponizing" allowfullscreen></iframe>
                                        </div>
                                        <h5 class="card-title">Weaponizing</h5>
                                        <p class="card-text">Techniques for weaponizing vulnerabilities.</p>
                                        <a href="https://www.youtube.com/watch?v=WS2TB8_RiJk" target="_blank" class="card-btn">Watch on YouTube <i class="fas fa-external-link-alt ms-2"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-4 mb-4">
                                <div class="card video-card" data-video-id="53">
                                    <div class="card-body">
                                        <div class="video-container">
                                            <iframe src="https://www.youtube.com/embed/OtV-OA6tb-4" title="Bug Bounty" allowfullscreen></iframe>
                                        </div>
                                        <h5 class="card-title">Bug Bounty</h5>
                                        <p class="card-text">Introduction to bug bounty hunting.</p>
                                        <a href="https://www.youtube.com/watch?v=OtV-OA6tb-4" target="_blank" class="card-btn">Watch on YouTube <i class="fas fa-external-link-alt ms-2"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
